...
public class ExceptionGlobalHandler {
	...
	public ResponseEntity<ResponseDTO> runtimeException(RuntimeException e) {
		ResponseDTO response = new ResponseDTO(HttpStatus.INTERNAL_SERVER_ERROR.value(), e.getClass().getName(), e.getMessage());
	...
	public ResponseEntity<ResponseDTO> notFoundException(ApiNotFoundException e){
		ResponseDTO response = new ResponseDTO(HttpStatus.NOT_FOUND.value(), e.getClass().getName(), e.getLocalizedMessage());
