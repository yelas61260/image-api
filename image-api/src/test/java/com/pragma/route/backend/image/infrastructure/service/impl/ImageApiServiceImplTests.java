...
public class ImageApiServiceImplTests {
	...
	public void setup() {
		...
		Mockito.doThrow(ImageIdConflictException.class).when(imageService).prepareToCreate(ImageDtoDataTests.imageOKCreated, ImageFileDataTests.stringByteOk);
		Mockito.doThrow(ImageIdConflictException.class).when(imageService).prepareToCreate(ImageDtoDataTests.imageOKCreatedImageEmpty, ImageFileDataTests.stringByteOk);
		Mockito.doThrow(ImageIdConflictException.class).when(imageService).prepareToCreate(ImageDtoDataTests.imageOKUpdated, ImageFileDataTests.stringByteOk);
		Mockito.doThrow(ImageIdConflictException.class).when(imageService).prepareToCreate(ImageDtoDataTests.imageOKUpdatedImageEmpty, ImageFileDataTests.stringByteOk);
