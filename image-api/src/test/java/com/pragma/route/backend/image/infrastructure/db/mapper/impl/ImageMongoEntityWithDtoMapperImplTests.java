...
public class ImageMongoEntityWithDtoMapperImplTests {
	...
	public void setup() {
		...
		imageMongoEntityOk = ImageMongoEntity.builder()
				.id("PI"+ImageManagerGlobalConstant.IMAGE_ID_SPLIT_CHART+1)
				.bodyBase64("Content")
				.imageName("imagen")
				.build();
		
		imageMongoEntityError = ImageMongoEntity.builder()
				.id("PI"+ImageManagerGlobalConstant.IMAGE_ID_SPLIT_CHART+2)
				.bodyBase64("Content2")
				.imageName("imagen2")
				.build();
	}
