...
public class ImageServiceImplTests {
	...
	public void setup() {
		...
		Mockito.doThrow(ImageIdConflictException.class).when(imageDomainService).prepareToCreate(ImageDataTests.imageOKCreated, ImageFileDataTests.stringByteOk);
		Mockito.doThrow(ImageIdConflictException.class).when(imageDomainService).prepareToCreate(ImageDataTests.imageOKCreatedImageEmpty, ImageFileDataTests.stringByteOk);
		Mockito.doThrow(ImageIdConflictException.class).when(imageDomainService).prepareToCreate(ImageDataTests.imageOKUpdated, ImageFileDataTests.stringByteOk);
		Mockito.doThrow(ImageIdConflictException.class).when(imageDomainService).prepareToCreate(ImageDataTests.imageOKUpdatedImageEmpty, ImageFileDataTests.stringByteOk);
	...
	public void prepareToCreate() {
		...
		assertThrows(ImageIdConflictException.class, () -> imageService.prepareToCreate(ImageDtoDataTests.imageOKCreated, ImageFileDataTests.stringByteOk));
		assertThrows(ImageIdConflictException.class, () -> imageService.prepareToCreate(ImageDtoDataTests.imageOKCreatedImageEmpty, ImageFileDataTests.stringByteOk));
		assertThrows(ImageIdConflictException.class, () -> imageService.prepareToCreate(ImageDtoDataTests.imageOKUpdated, ImageFileDataTests.stringByteOk));
		assertThrows(ImageIdConflictException.class, () -> imageService.prepareToCreate(ImageDtoDataTests.imageOKUpdatedImageEmpty, ImageFileDataTests.stringByteOk));
